...
describe("schemaRoundtripInventory", () => {
  it.skipIf(!existsSync(codebaseAtlasRoot))(
    "classifies real Codebase Atlas schema roundtrips without blocking",
    () => {
      ...
      const app = result.results.find(
        (entry) => entry.repo === "codebase-atlas",
      );
