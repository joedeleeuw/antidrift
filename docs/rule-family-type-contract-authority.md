...
| Contract shape duplication        | default-off `antidrift/no-structural-type-fork`, default-off `antidrift/no-canonical-model-fork`, default-off `antidrift/no-inline-structural-type-at-use-site`, default-off `antidrift/no-nullable-positional-tuple` | Default-off inventory                | TypeChecker, registry facts, and deterministic AST                              | Local structural copies of owner types, exported inline object contracts, and ambiguous nullable positional tuples.                                | Imported owner types, named DTO/input contracts, schema-inferred types, and named object ranges.                                                         |
