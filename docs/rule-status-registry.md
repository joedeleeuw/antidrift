...
| `antidrift/no-unsafe-deserialize`                 |        `ready` |     no | TypeChecker plus local string-boundary control flow       | `partial-overlap` / `own-antidrift`    | Run final promotion review/advisory for the parse-at-edge rule.                                                                               |
