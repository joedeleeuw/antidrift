...
| `antidrift/no-redundant-zod-parse`                 |                `ready` |     no | Canonical-path schema provenance (Oxlint syntax tier)                                                                                                        | `net-antidrift` / `own-antidrift`    | Default-off inventory after the 2026-08-13 Oxlint migration; re-inventory against the canonical-path engine before restoring blocking severity.                                                                             |
