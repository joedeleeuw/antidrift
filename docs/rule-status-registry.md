...
| `antidrift/no-defensive-shape-probing`            |        `ready` |     no | TypeChecker plus AST shape                                                                            | `partial-overlap` / `own-antidrift`    | Disputed: demote to inventory/off unless a second drift proves value beyond upstream unsafe-member checks.                                                                         |
