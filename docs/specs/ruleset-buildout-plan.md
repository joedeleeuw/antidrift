...
| ------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| `no-handrolled-resource-lifecycle-cells`    | codified-under-proven (multi-repo positives) | human review proves the fixed lifecycle diagnostics are drift, not ordinary form/mutation state → else keep default-off or retire |
...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **lifecycle-cells**                                 | `pnpm policy:inventory-react-state` → `reports/react-state-inventory.json`; `verify-session` green; consumer package still passes if fact payload changes                                                                                                                                                                                                                                                                                  | fixed proof now catches Chaski reporting screens, Sudocode execution handlers, and Cloudflare example lifecycle handlers; ignores stale-while-revalidate / pagination / UI-cleanup / abort-guarded / owned-hook controls. Next value gate is human review plus clean-control pressure, not another synthetic shape. |
