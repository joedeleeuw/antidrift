...
| ---: | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
|    1 | `antidrift/no-sql-string-concat` stable blockers                                | Classify broad SQL findings, SQL tag ecosystems, equivalent guard shapes, concatenation false negatives, and non-type-aware imported-escaper behavior. | Security value is high and the rule now has production drift, clean controls, lower-edge pressure, imported escaper proof, and grounded advisory reviews naming the remaining blockers. |
