...
| ---: | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
|    1 | `antidrift/no-sql-string-concat` imported escaper proof                         | Decide whether to prove imported SQL escaper helpers across files or explicitly scope them out of stable promotion.                            | PowerSync resolved lower-edge pressure, but exposed a real false-positive case for imported `escapeMysqlTableName(table)`.                 |
...
| `antidrift/no-sql-string-concat`                  | Ready, not stable         | Has second-repo sanitized identifier replication through Opencode and lower-edge pressure through PowerSync, but imported escaper proof is unresolved.                                                     |
...
| --------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| SQL imported escaper proof is unresolved.                                                                           | `antidrift/no-sql-string-concat`    | Keep ready but not stable until imported escaper false-positive pressure is fixed or explicitly declared out of stable scope.                        |
...
1. `antidrift/no-sql-string-concat`: decide and execute imported escaper proof, or explicitly declare cross-file SQL escaper validation out of stable scope.
