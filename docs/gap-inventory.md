...
| ---: | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
|    1 | `antidrift/no-sql-string-concat` stable blockers                                | Classify broad SQL findings and non-type-aware imported-escaper behavior. Keep SQL tag, guard-shape, and builder-append inventory running as regression evidence. | Security value is high and the rule now has production drift, clean controls, lower-edge pressure, imported escaper proof, measured tag/guard/builder inventories, and grounded advisory reviews naming the remaining blockers. |
...
| --------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| SQL stable-promotion blockers remain after imported escaper proof.                                                   | `antidrift/no-sql-string-concat`    | Keep ready until broad SQL findings and the measured non-type-aware imported-escaper extra report are resolved or explicitly accepted. |
