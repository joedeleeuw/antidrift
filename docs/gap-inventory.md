...
| ---: | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
|    1 | `antidrift/no-sql-string-concat` stable-promotion review                        | Run a fresh review now that lower-edge pressure and imported escaper proof are covered by real corpus gates.                                   | Security value is high and the rule now has production drift, clean controls, lower-edge pressure, and imported escaper proof.             |
...
| `antidrift/no-sql-string-concat`                  | Ready, not stable         | Has second-repo sanitized identifier replication through Opencode plus lower-edge and imported escaper proof through PowerSync; needs a stable-promotion review.                                            |
...
| --------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| SQL stable-promotion decision is pending after imported escaper proof.                                               | `antidrift/no-sql-string-concat`    | Keep ready until a fresh review confirms whether remaining uncharacterized guard shapes block stable promotion.                                  |
...
1. `antidrift/no-sql-string-concat`: run a fresh stable-promotion review after the PowerSync lower-edge and imported-escaper gates.
