...
| ---: | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
|    1 | `antidrift/no-sql-string-concat` guard/escaper lower-edge pressure              | Find one real near-miss guard or escaper that looks protective but still reports.                                                            | Security value is high and the rule now has second-repo sanitized identifier replication; promotion is blocked by edge evidence.           |
...
| `antidrift/no-sql-string-concat`                  | Ready, not stable         | Has second-repo sanitized identifier replication through Opencode, but needs a real invalid/near-miss guard or escaper control before stable promotion.                                                   |
...
| --------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| SQL guard/escaper proof lacks lower-edge pressure.                                                                  | `antidrift/no-sql-string-concat`    | Keep ready but not stable until a real near-miss/invalid guard or escaper remains reported.                                                        |
...
1. `antidrift/no-sql-string-concat`: find one invalid/near-miss guard or escaper that still reports.
