...
| ---: | --------------------------------------- | ------------------------------ | ---------------------------------- | -------------------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    1 | `antidrift/no-appeasement-cast`         | remediation-required           | continue                           | Chaski, Codebase Atlas, Sudocode | Chaski, antidrift                 | Type-escape hatches are core scope; upstream benchmark proved `@typescript-eslint/no-unsafe-type-assertion` is a much broader superset, so custom ownership remains justified while production cleanup evidence is collected. |
...
Work on `antidrift/no-appeasement-cast` first. Broad inventory, advisory review, and the measured upstream delta are complete enough to define the next slice: collect remediation evidence for classified production drift before stable-promotion work.
