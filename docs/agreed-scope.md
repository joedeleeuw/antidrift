...
| Error handling                | Reliability              | ESLint baseline rules, future custom rules, and Sonar                          | Keep baseline empty-catch/console protections and ESLint `preserve-caught-error`; future custom work should target fallback-to-empty rather than owning a low-utility silent-catch matcher. |
